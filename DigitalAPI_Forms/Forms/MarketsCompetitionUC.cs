...
{
    public partial class MarketsCompetitionUC : UserControl
    {
        DigitalAPItester digitalAPI;
        public MarketsCompetitionUC(DigitalAPItester mainForm)
        {
            digitalAPI = mainForm;
            InitializeComponent();
        }
        ...
        private void CallApiBTN_Click(object sender, EventArgs e)
        {
            ...
            digitalAPI.MarketsCompetition(sportName, competitionName, jurisdiction, loop);
        }
