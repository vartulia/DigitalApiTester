...
{
    public partial class TournamentsUC : UserControl
    {
        DigitalAPItester digitalAPI;
        public TournamentsUC(DigitalAPItester mainForm)
        {
            digitalAPI = mainForm;
            InitializeComponent();
        }
        ...
        private void CallApiBTN_Click(object sender, EventArgs e)
        {
            ...
            digitalAPI.Tournaments(sportName, competitionName,jurisdiction,loop);
        }
    }
}
